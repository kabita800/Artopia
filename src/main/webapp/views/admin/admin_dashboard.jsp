...
<head>
    ...
    <style>
        ...
        *{ margin:0; padding:0; box-sizing:border-box; }
        ...
        .topbar h1{ font-size:2rem; font-family:'Playfair Display', serif; }
        ...
        .stat-card h3{ color:var(--accent); font-size:2rem; margin-bottom:10px; }
        ...
        .activity-info h4{ font-size:0.95rem; margin-bottom:4px; }
        .activity-info p{ color:var(--muted); font-size:0.82rem; }
        .activity-tag{ color:var(--accent); font-weight:600; font-size:0.85rem; }
        ...
        .quick-btn h3{ color:var(--accent); margin-bottom:6px; }
        .quick-btn p{ color:var(--muted); font-size:0.82rem; }
        ...
        .mini-card h3{ color:var(--accent); margin-bottom:10px; }
        .mini-card p{ color:var(--muted); line-height:1.6; }
...
<div class="main">
        ...
        <div class="dashboard-card">
            ...
            <div class="dashboard-card-body">
                ...
                <div class="quick-actions">
                    ...
                    <div class="quick-btn"
                         onclick="location.href='${pageContext.request.contextPath}/admin/manageUsers'">
                        <h3>+ User</h3>
                        <p>Manage users</p>
                    </div>
    ...
    <div class="bottom-grid">
        ...
        <div class="mini-card">
            <h3>Total Artists</h3>
            <p>${totalArtists} active artists are selling artworks on Artopia.</p>
        </div>

        <div class="mini-card">
            <h3>Total Buyers</h3>
            <p>${totalBuyers} buyers have registered on Artopia.</p>
        </div>
